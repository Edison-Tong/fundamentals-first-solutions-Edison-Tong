...
// let fruits = [];
// for (let i = 0; i < 5; i++) {
//   fruits.push(prompt("Gimme a fruit"));
// }
// console.log(fruits);
...
// let spliced = letters.splice(letters.length - 3, 3);
...
// let jNames = ["Jeff", "John", "Jerry", "Jenson", "Jerome", "Jordan", "Jackson", "Jared"];
// let reverse = [];
// for (let i = jNames.length - 1; i >= 0; i--) {
//   reverse.push(jNames[i]);
// }
// console.log(reverse);

// Practice: High, Medium, and Low Numbers
// Write a for loop that loops over every twentieth number from 1400 to 1600, inclusive.
// For each number, log a message to the consolethat indicates whether the number is
